package com.miteno.pulgin.mybatis.plugin;
...
import com.miteno.pulgin.jdbc.dialet.Dialect;
...
public class PagePlugin implements Interceptor {
	...
	private static String pageSqlId = ".*query.*"; // mybaits的数据库xml映射文件中需要拦截的ID(正则匹配)
