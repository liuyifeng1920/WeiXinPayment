...
//		System.err.println("-----------MyUserDetailServiceImpl loadUserByUsername ----------- ");
		...
		//取得用户的权限
		com.miteno.entity.User users = userDao.querySingleUser(username);
		if  (users==null)  
	...
	// 取得用户的权限
	private Set<GrantedAuthority> obtionGrantedAuthorities(com.miteno.entity.User user) {
