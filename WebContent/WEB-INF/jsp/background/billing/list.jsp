...
<body>
<form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/billing/query.action" method="post">
<table width="100%">
  <tr>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：渠道管理-计费渠道查询</td>
              </tr>
            </table></td>
  	...
  	<div class="search_k" align="left">
		<fieldset class="search">
			...
			<div class="search_content">
				计费渠道ID：<input type="text" name="appid" value="${param.appid}" style="height: 20px"/>　　
				计费渠道名称：<input type="text" name="appname" value="${param.appname}" style="height: 20px"/>　
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
           <!--  <td width="3%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" >
            ...
            <td width="6%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">计费渠道ID</span></td>
            <td width="8%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">计费渠道名称</span></td>
            <td width="21%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">app标识</td>
            <td width="21%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">app秘钥</td>
            <td width="20%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">开发者用户ID</td>
            <td width="8%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">开发者调用密码</td>
            <td width="18%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">基本操作</td>
          </tr>
          
          <c:forEach var="key" items="${pageView.records}">
          <tr>
              <!--<td height="20" >
              <input type="checkbox" name="check" value="${key.appid}" />
            	</td>  -->
              <td height="20" ><span class="STYLE1">${key.appid}</span></td>
             <td height="20" ><span class="STYLE1">${key.appname}</span></td>
             <td height="20" ><span class="STYLE1">${key.appkey}</span></td>
             <td height="20" ><span class="STYLE1">${key.appsecret}</span></td>
             <td height="20" ><span class="STYLE1">${key.platformID}</span></td>
             <td height="20" ><span class="STYLE1">${key.password}</span></td>
            ...
            <a href="${pageContext.servletContext.contextPath }/background/billing/getById.action?appid=${key.appid}&&type=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
           </sec:authorize>
           <sec:authorize ifAnyGranted="ROLE_sys_user_delete">
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="javascript:void(0);" onclick="deleteId('${pageContext.servletContext.contextPath }/background/billing/deleteById.action?appid=${key.appid}');">
            	删除</a>
            	</sec:authorize>
            	</span></td>
          </tr>
