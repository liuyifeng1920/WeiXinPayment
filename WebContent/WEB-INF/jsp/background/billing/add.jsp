...
<body>
	<div style="height: 100%;overflow-y: auto;">
		<br /> <br />
		<form
			action="${pageContext.servletContext.contextPath }/background/billing/add.action"
			method="post">
			<table class="ttab" height="100" width="50%" border="0"
				...
				<td height="30" width="30%">
					...
					<td>
						<div align="left" class="STYLE1" style="padding-left:10px;">
							<input style="height: 20px;width: 200px" name="appid" value="${appid}" readonly="readonly"/>
						</div></td>
					</tr>
				<tr>	
					<td height="30" width="30%">
					...
					<td>
						<div align="left" class="STYLE1" style="padding-left:10px;">
							<input style="height: 20px;width: 200px" name="appname" />
						</div></td>
						</tr>
				...
				<tr>
					...
					<td>
						<div align="left" class="STYLE1" style="padding-left:10px;">
							<input style="height: 20px;width: 200px" name="appkey"/>
						</div></td>
						</tr>
				<tr>
					<td height="30" width="30%">
					...
					<td>
						<div align="left" class="STYLE1" style="padding-left:10px;">
							<input style="height: 20px;width: 200px" name="appsecret" />
						</div></td>
				</tr>
				<tr>
					<td height="30" width="30%">
					...
					<td>
						<div align="left" class="STYLE1" style="padding-left:10px;">
							<input style="height: 20px;width: 200px" name="platformID" />
						</div></td>
				</tr>
				<tr>
					<td height="30" width="30%">
					...
					<td>
						<div align="left" class="STYLE1" style="padding-left:10px;">
							<input style="height: 20px;width: 200px" name="password" />
						</div></td>
				</tr>
				<tr>
