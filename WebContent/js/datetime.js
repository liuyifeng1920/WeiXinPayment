(function(){
	var d=document,
		...
		ids=null,
		oInput=null;
	document.write('<iframe frameborder=0 style="display:none;position:absolute;" width="85%" height="350" scrolling="no" name="sangcalender" id="sangcalender"></iframe>');
	var f=window.frames['sangcalender'];
	var ff=d.getElementById('sangcalender');
	var fd=f.document;
	fd.open();
	fd.write('<!DOCTYPE html><html><head><style type="text/css">#yearL, #monthL, #monthR, #yearR, #hoursL, #hoursR, #minL, #minR, #y, #m, #h, #i, #s{cursor:pointer;}.calenderClose a{display:block;width:13px;line-height:13px;border:1px solid #cccccc;background-color:#eeeeee;color:#666; text-decoration:none}.calenderClose a:hover{color:red}td{text-align:center}#calenderDay{cursor:pointer}body{font-size:16px;font-family:"黑体";padding:0;margin:0}.col666{color:#999}.bg9ebdd6{background-color:#ddb7ab}</style></head><body onselectstart="return false" style="-moz-user-select:none" oncontextmenu="return false">')
	fd.write('<table width="100%" border="0" bgcolor="#CCCCCC" cellspacing="1" cellpadding="0">'+
			 '<tr><td><table border="0" cellspacing="0" bgcolor="#d94716" cellpadding="0" width="100%">'+
			 '<tr><td width="40" height="50" align="center" id="yearL" title="上一年">&lt;&lt;</td>'+
			 '<td width="24" align="center" id="monthL" title="上一月">&lt;</td><td align="center">'+
			 '<span id="y" title="点击选择年份"></span>年<span id="m" title="点击选择月份"></span>月</td>'+
			 '<td width="24" align="center" id="monthR" title="下一月">&gt;</td>'+
			 '<td width="40" align="center" id="yearR" title="下一年">&gt;&gt;</td></tr></table></td></tr>'+
			 '<tr bgcolor="#FFFFFF"><td><table width="100%" border="0" bgcolor="#fdac91" cellspacing="1" cellpadding="0">'+
			 '<tr bgcolor="#fecebe" height="28"><td>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td>六</td></tr></table></td></tr>'+
			 ...
			 '<tr><td align="center" height="30" id="hoursL" title="时减少">&lt;&lt;</td>'+
	...
	function formatDay(timestr){
		...
		for(var md=mon[date['m']-1],wd=md-date['w']+1,n=0;n<6;n++){
			str+='<tr bgcolor="#ffffff" height="33">';
